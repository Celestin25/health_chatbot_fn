...
const HeroSection: React.FC = () => {
  ...
  const images = [
    ...
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUl6dDZgOqbvYPTvQRTt5kLNLLWoPfdPMATg&s",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqIAqN-KTqNW2m-oaRf858AX3B8HpIcA6yrw&s",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSiCYkSQmuYPnimgc8uvwy6AulE89zbVABGgQ&s",
  ];
    ...
    <section className=" bg-gradient-to-r from-primary to-primaryGradient text-white text-xl px-8 py-[20vh]  md:px-8 lg:px-16 flex flex-col lg:flex-row items-center gap-8 lg:gap-64 font-outfit justify-start items-start">
      <div className="w-full text-center items-center xl:text-start xl:items-start  flex flex-col gap-4 lg:gap-8">
        <h1 className="text-3xl font-bold">
          <span className="text-secondary">MindMed</span> E-Health
        </h1>
